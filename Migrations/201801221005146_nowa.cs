namespace GlsLeague.Migrations
{
    ...
    public partial class nowa : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        IsCompetitionActvie = c.Boolean(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.CompetitionEvents", "EventID", "dbo.Events");
            DropForeignKey("dbo.CompetitionEvents", "CompetitionID", "dbo.Competitions");
            ...
            DropIndex("dbo.CompetitionEvents", new[] { "EventID" });
            DropIndex("dbo.CompetitionEvents", new[] { "CompetitionID" });
